...
// Operator wallet — all agents are owned by this EVM (GOAT) address.
// Override via GOAT_OPERATOR_ADDRESS; defaults to a placeholder 0x address.
const OPERATOR_WALLET =
  process.env.GOAT_OPERATOR_ADDRESS ?? "0x000000000000000000000000000000000000dEaD";
