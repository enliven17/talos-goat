 ...
 *
 * Persists the choice in localStorage and reapplies on mount so a fresh tab
 * doesn't flash the wrong palette. The palette switch happens via
...
export function ThemeToggle() {
  ...
  // Avoid a flash of the wrong icon between SSR and client hydration.
  if (!mounted) {
