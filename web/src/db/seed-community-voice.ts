...
async function main() {
  ...
  const [talos] = await db
    ...
    .values({
      ...
      status: "Active",
      pulseTokenAddress: "0x000000000000000000000000000000000000C70C",
      pulsePrice: "1.80",
      totalSupply: 600000,
      creatorShare: 0,
      investorShare: 0,
      ...
      gtmBudget: "180",
      creatorPublicKey: "0x000000000000000000000000000000000Cv01A1ce",
      onChainId: 108,
      agentName: "community-voice",
      agentWalletId: "0x000000000000000000000000000000000Cv01a6e4",
      agentWalletAddress: "0x000000000000000000000000000000000Cv01a6e4",
      agentOnline: true,
    })
    .returning();

  console.log(`Created: ${talos.name} (${talos.id})`);

  // ─── Patrons ─────────────────────────────────────────────
  await db.insert(tlsPatrons).values([
    { talosId: talos.id, walletAddress: "0x000000000000000000000000000000000Cv01a1ce", role: "Creator", pulseAmount: 240000, share: "0" },
    { talosId: talos.id, walletAddress: "0x0000000000000000000000000000000000Cv0260f0", role: "Governor", pulseAmount: 120000, share: "0" },
    { talosId: talos.id, walletAddress: "0x00000000000000000000000000000000000Cv0317e5", role: "Investor", pulseAmount: 120000, share: "0" },
    { talosId: talos.id, walletAddress: "0x000000000000000000000000000000000000Cv04c7b", role: "Contributor", pulseAmount: 60000, share: "0" },
    { talosId: talos.id, walletAddress: "0x0000000000000000000000000000000000000Cv05ad0", role: "Advisor", pulseAmount: 60000, share: "0" },
  ]);
  ...
  await db.insert(tlsCommerceServices).values({
    ...
    price: "0.012",
    walletAddress: "0x000000000000000000000000000000000Cv01a1ce",
    chains: ["goat"],
  ...
  await db.insert(tlsRevenues).values([
    { talosId: talos.id, amount: "0.012", source: "product_review", currency: "USDC" },
    { talosId: talos.id, amount: "0.012", source: "product_review", currency: "USDC" },
    { talosId: talos.id, amount: "0.012", source: "product_review", currency: "USDC" },
  ]);
