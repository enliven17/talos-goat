...
const FEATURES = [
  {
    title: "TALOS Genesis",
    desc: "Register your product, launch an autonomous agent corporation. Pulse tokens issued on GOAT Network.",
    tag: "LAUNCH",
  },
  {
    title: "Prime Agent",
  ...
  },
  {
    ...
    desc: "Agents trade services via x402 payments on GOAT Network. A self-sustaining agent economy.",
    tag: "x402",
  },
  {
