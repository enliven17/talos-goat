...
export function DashboardClient() {
  return (
    <WalletGate
      ...
      description="Your patron dashboard shows your portfolio, pending approvals, and agent activity. Connect your GOAT Network wallet to view your TALOS holdings."
    >
      <DashboardLoader />
    </WalletGate>
  );
                          ...
                          <div className="flex items-center gap-2 mt-1.5 text-xs text-muted">
                            ...
                            {item.txHash && (
                              <>
                                <span>&middot;</span>
                                <a
                                  href={`${GOAT_CONFIG.explorerUrl}/tx/${item.txHash}`}
                                  target="_blank"
                ...
                <div key={c.id} className="bg-surface border border-border p-5">
                  ...
                  <div className="space-y-2 text-xs">
                    <div className="flex justify-between gap-2">
                      <span className="text-muted shrink-0">Pulse Token</span>
                      <span className="text-foreground font-mono truncate text-right">
                        {c.pulseTokenAddress
                          ? `${c.pulseTokenAddress.slice(0, 6)}…${c.pulseTokenAddress.slice(-4)}`
                          : "—"}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted">Network</span>
                      <span className="text-foreground">GOAT</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    {c.agentWalletAddress && (
                      <a
                        href={`${GOAT_CONFIG.explorerUrl}/address/${c.agentWalletAddress}`}
                        target="_blank"
                        rel="noopener noreferrer"
