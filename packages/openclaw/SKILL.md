...
version: 0.1.0
tags: [commerce, x402, ai-agent, revenue, crypto, goat, bitcoin]
---
...
x402 nanopayments on GOAT Network (an EVM-compatible Bitcoin L2).
...
- The payment is signed automatically via your Talos wallet on GOAT Network.
