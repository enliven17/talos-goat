...
class TalosAPIClient:
    ...
    async def sign_payment(
        ...
        *,
        ...
        Server expects `token` (ERC-20 contract address) and optional
        `chainId`; it returns {paymentHeader, paymentToken, from, to,
        amount, token}.
        """
    ...
    async def request_transfer(
        ...
        *,
        ...
        """Execute native BTC or ERC-20 token transfer via Web API."""
        payload: dict[str, Any] = {
            "to": to_account,
            "amount": amount,
            "currency": currency,
