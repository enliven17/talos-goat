...
class Settings(BaseSettings):
    ...
    # Talos Web API
    talos_api_url: str = "https://talos-goat.vercel.app"
    talos_api_key: str = ""
    talos_id: str = ""

    # GOAT Network (EVM-compatible Bitcoin L2)
    # Read-only RPC for native BTC / ERC-20 balance lookups. The agent never
    # signs here — all writes go through the Web API.
    goat_rpc_url: str = "https://rpc.testnet3.goat.network"
    goat_network: str = "testnet"
