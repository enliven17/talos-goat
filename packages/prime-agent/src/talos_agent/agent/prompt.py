...
10. **Distribute**: If revenue was earned → distribute dividends via transfer_btc
...
- Below threshold: execute autonomously (use transfer_btc or purchase_service directly)
...
- Internal economy (dividends): use transfer_btc
